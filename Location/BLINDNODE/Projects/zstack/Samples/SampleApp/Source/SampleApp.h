...
#define SAMPLEAPP_ROUT_ANODE_CLUSTERID 5//锚节点
#define SAMPLEAPP_ROUT_BNODE_CLUSTERID 6
#define SAMPLEAPP_ROUT_CNODE_CLUSTERID 7
#define SAMPLEAPP_BLIND_CLUSTERID      8//盲节点
#define SAMPLEAPP_DEFAULT_ANCHOR       A //默认的锚节点
...
#define USER_EVT 0X0008 //自定义用户事件
